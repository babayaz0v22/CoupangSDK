...
public class HmacOrderAddress {
    ...
    private static final String SECRET_KEY = "8c2b885d798b0eb3764435b3fb22cea4d84965ff";
...
//                    .addParameter("status", "FINAL_DELIVERY");
    ...
    public static void main(String[] args) {
        HmacOrderAddress hmacTest = new HmacOrderAddress();
        hmacTest.test();
    }
}