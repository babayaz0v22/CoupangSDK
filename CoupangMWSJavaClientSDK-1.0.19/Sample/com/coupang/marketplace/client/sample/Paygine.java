...
public class Paygine {
    ...
    public void test() {
        //params
        String method = "GET";
        String path = "/v2/providers/openapi/apis/api/v4/vendors/A00462959/ordersheets";
        ...
        try {
            ...
            URIBuilder uriBuilder = new URIBuilder()
                    .setPath(path)
                    .addParameter("createdAtFrom", "2024-05-04")
                    .addParameter("createdAtTo", "2024-06-03")
                    .addParameter("maxPerPage", "50")
                    .addParameter("status", "INSTRUCT");
